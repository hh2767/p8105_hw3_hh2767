...
<img src="p8105_hw3_hh2767_files/figure-markdown_github/unnamed-chunk-14-1.png" width="90%" /> The plot above is a two-panel plot. The left one shows the distribution of mean max temperature of January observed at each station, while the right one shows the distribution of mean max temperature of July observed at each station. The result

...
```
    ...
    ##  2 US1NYAB0001 2008  January 02        8.6    10.9     445     NA     NA
...
snow_plot = ny_noaa %>% 
  ...
  ggplot( aes(x = year, y = snow_mm, fill = year)) +
    geom_boxplot() + theme(legend.position = "null") + viridis::scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_text(face = "plain", color = "black", size = 5, angle = 60))

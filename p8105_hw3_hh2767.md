...
ggplot(filter(count, n >= 10000), aes(x = aisle, y = n)) + 
  ...
  coord_flip() + theme(axis.text.x = element_text(face = "plain", color = "black", size = 4))  + 
...
<img src="p8105_hw3_hh2767_files/figure-markdown_github/unnamed-chunk-16-2.png" width="90%" />
